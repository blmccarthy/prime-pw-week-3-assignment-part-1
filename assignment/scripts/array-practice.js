...
let favFoods = [ 'Pad Thai', 'Lobster Roll', 'Cheesy Gordita Crunch from Taco Bell®' ];
...
favFoods.push('Wings')
console.log('Added a new favorite food:', favFoods);
...
console.log('Removed my first favorite food:', removedFood);
console.log('My favorite foods are now:', favFoods);
